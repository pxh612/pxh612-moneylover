...
//        this.password = password;
        ...
        try {
            URL url = new URL(URLs.USER_REGISTER_API);
    ...
    private static LoginActivity.LOGIN_STATUS fetchResponseIsSuccessful(JSONObject response) {
        ...
        try {
            ...
            if(status.equals("true")){
                ...
                Log.d("__ String value:", "UserRegisterAPI > fetchResponseIsSuccessful > access_token : " + access_token);
                Log.d("__ String value:", "UserRegisterAPI > fetchResponseIsSuccessful > expire : " + expire);
                Log.d("__ String value:", "UserRegisterAPI > fetchResponseIsSuccessful > refresh_token : " + refresh_token);
