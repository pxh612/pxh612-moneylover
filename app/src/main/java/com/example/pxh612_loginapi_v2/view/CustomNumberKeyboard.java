...
public class CustomNumberKeyboard extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // initialize buttons
        LayoutInflater.from(context).inflate(R.layout.custom_number_keyboard, this, true);
